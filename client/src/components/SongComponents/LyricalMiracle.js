...
const LyricalMiracle = () => {
    ...
    //    }
    //}
    //<a-entity ref={quartetSound} onClick={quartet} geometry="primitive: cylinder; radius: 0.8; height: 1.6" scale="" position="-8 1 -5" //material="transparent: true; color: #a3d1ab" id="squartetSound" rotation="0 180 0"></a-entity>
   ...
   let lyricsArray=[];
    ...
    return (
        <>
            <a-assets><img id="strawberry" crossOrigin="anonymous" preload="auto" src="https://cors-anywhere.herokuapp.com/https://i.pinimg.com/originals/bc/d1/11/bcd1116aa32c8768e66525d4f6148dcf.jpg"></img>
            <img id="flowers" crossOrigin="anonymous" preload="auto" src="https://cors-anywhere.herokuapp.com/https://mk-website-media.s3.amazonaws.com/wp-content/uploads/2018/10/18234402/Wallpaper-KH-FlowePool-Fullbloom-1-1100x1318.jpg"></img></a-assets>
