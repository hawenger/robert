...
const SwanSong = () => {
  ...
  return (
    <>
      <a-entity ref={playASongButton} onClick={playASong} id="stopTheSongButton" geometry="primitive: cone; height: 2; radiusBottom: 0.1; radiusTop: 1" scale="" position="1.2 0.859 -0.5" material="src: #flowers; transparent: true; color: #a3d1ab" id="stopSongButton" rotation="0 180 0"><a-entity id="spheretop" geometry="primitive: sphere; radius: .6" position="0 1 0" material="src: #strawberry"></a-entity></a-entity>
      <a-entity ref={stopASongButton} onClick={stopASong} id="startTheSongButton" geometry="primitive: cone; height: 2; radiusBottom: 0.1; radiusTop: 1" scale="" position="3.4 0.859 0" material="src: #flowers; transparent: true; color: #a3d1ab" id="startSongButton" rotation="0 180 0"><a-entity id="spheretop" geometry="primitive: sphere; radius: .6" position="0 1 0" material="src: #strawberry"></a-entity></a-entity>
    </>
  )
}
